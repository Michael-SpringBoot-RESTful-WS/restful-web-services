 ...
 * 
 */
package com.in28minutes.rest.webservices.swagger.configuration;
...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Awesome API Description", "Awesome Api Documentation",
